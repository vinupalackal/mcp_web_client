    ...
    *,
    ...
    if is_direct_fact:
        return (
            ...
            "4. Answer the user's question directly and completely:\n"
            "   • State the primary fact asked for (e.g. top process, current value).\n"
            "   • Include all directly relevant supporting detail from the tool output: "
            "PID, user/owner, memory amount and percentage of total, CPU %, command or "
            "service name, and any other fields present in the output that help "
            "understand the answer.\n"
            "   • If the tool returned a ranked list (e.g. top-N by memory), include "
            "the top 3–5 entries in a compact table or bullet list so the user can see "
            "the full picture, not just the single top result.\n"
            "5. Do NOT add unsolicited health assessments, maintenance recommendations, "
            "or speculation about causes — unless the data itself shows something "
            "clearly abnormal (e.g. a single process using >80 % of RAM).\n"
            "6. If the tool failed, say what could not be determined.\n"
